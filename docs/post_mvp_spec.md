...
- **D-173** (open) — direct-mount + push-credentials interaction
- **D-174** (open) — cache mount trust-shared surface
- **D-175** (open) — constrained DNS resolver (not v1.0-blocking; leaning "don't adopt" per friction analysis)
